...
6. Optionally create an initial `OPENCODE.md` (or `CLAUDE.md`) for the group
...
You can read and write to `/workspace/project/groups/global/OPENCODE.md` (or `CLAUDE.md`) for facts that should apply to all groups. Only update global memory when explicitly asked to "remember this globally" or similar.
